...
def analisar_com_ollama(
    ...
    log.info(f"Enviando dados para o {MODEL}...")
...
def buscar_imoveis_tendencia(
    ...
    analise = analisar_com_ollama(conteudo, api_key=api_key)
...
if __name__ == "__main__":
    ...
    buscar_imoveis_tendencia(api_key='ollama')
